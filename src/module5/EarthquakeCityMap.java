	...
	public void mouseClicked()
	{
		...
		if (lastClicked != null) {
			...
			for (Marker m : quakeMarkers) {
				...
				if(e.isInside(map, mouseX, mouseY) && !(e.isHidden())) {
					...
					for (Marker cm : cityMarkers) {
						...
						double r = e.threatCircle();
						
						if(cm.getDistanceTo(e.getLocation()) > r) {
			...
			for (Marker m : cityMarkers) {
				...
				if(c.isInside(map, mouseX, mouseY) && !(c.isHidden())) {
					...
					for (Marker eq : quakeMarkers) {
						...
						EarthquakeMarker e = (EarthquakeMarker) eq;
						
						double r = e.threatCircle();
						
						if(lastClicked.getDistanceTo(e.getLocation()) > r) {
