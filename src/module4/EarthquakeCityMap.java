...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		textSize(12);
		text("Earthquake Key", 750, 75);
		
		fill(color(255, 0, 0));
		triangle(730, 125, 730+4, 125-8, 730+8, 125);
		fill(color(255, 255, 255));
		ellipse(735, 150, 10, 10);
		fill(color(255, 255, 255));
		rect(730, 175-5, 10, 10);
		fill(color(255, 255, 0));
		ellipse(735, 225, 10, 10);
		fill(color(0, 0, 255));
		ellipse(735, 250, 10, 10);
		fill(color(255, 0, 0));
		ellipse(735, 275, 10, 10);
		
		fill(0, 0, 0);
		text("City Marker", 755, 125-8);
		text("Land Quake", 755, 150);
		text("Ocean Quake", 755, 175);
		text("Size ~ Magnitude", 730, 200);
		text("Shallow", 755, 225);
		text("Intermediate", 755, 250);
		text("Deep", 755, 275);
	}
